...
const mockInvitationData: InvitationPageProps = {
    invitation: {
        _id: "inv_123456789",
        createdAt: "2024-01-15T10:30:00Z",
        name: "John Doe",
        roleId: "role_server_001",
        managerId: "user_manager_001",
        restaurantId: "rest_bistro_001",
    },
    restaurant: {
        _id: "rest_bistro_001",
        ...
        description:
            "Um restaurante europeu moderno que oferece experiências gastronômicas requintadas com ingredientes locais e técnicas culinárias inovadoras.",
        ...
        tableIds: ["table_001", "table_002", "table_003"],
        sessionIds: ["session_001"],
    ...
    role: {
        ...
        name: "Server",
        description: "Responsável por anotar pedidos, servir comida e garantir excelente atendimento ao cliente",
        color: "#3B82F6",
        permissions: [
            {
                section: "pedidos",
            ...
            },
            {
                ...
                description: "Visualizar e atualizar status das mesas",
            },
            {
                section: "cardápio",
                permissions: ["view"],
                description: "Visualizar itens e preços do cardápio",
            },
        ],
    },
    manager: {
        ...
        lastLogged: new Date("2024-01-15T08:45:00Z"),
        firstName: "Sarah",
        lastName: "Johnson",
        email: "sarah.johnson@bistrodeluxe.com",
        phoneNumber: "+1 (555) 987-6543",
        firebaseUUID: "firebase_uuid_001",
        isAdmin: false,
        currentRestaurantId: "rest_bistro_001",
        isDeveloper: false,
...
export default function RestaurantInvitation({
                                                 invitation = mockInvitationData.invitation,
                                                 restaurant = mockInvitationData.restaurant,
                                                 role = mockInvitationData.role,
                                                 manager = mockInvitationData.manager,
                                                 invitedEmail = mockInvitationData.invitedEmail,
                                             }: Partial<InvitationPageProps> = {}) {
    ...
    const handleEmailSignup = (e: React.FormEvent) => {
        e.preventDefault()
        console.log("Email signup:", signupData)
    }
                                    ...
                                    {restaurant.settings.openingHours && (
                                        <div className="mt-4">
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                                                {Object.entries(restaurant.settings.openingHours).map(
                                                    ([day, hours]) =>
                                                        hours && (
